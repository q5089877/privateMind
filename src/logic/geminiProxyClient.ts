...
━━━━━━━━━━━━━━━━━━
【核心視角維度（依序輸出 4 句高質量起手式）】
━━━━━━━━━━━━━━━━━━
1. 【近｜焦點伸展】：直接從原文核心詞展開，探索最直接的感受、瞬間、亮點或核心動機。
2. 【中｜抽離期待】：抽離外界眼光、他人標準、評價焦慮或自我要求，回到不需要向任何人證明的真實位置。
3. 【遠｜尺度放寬】：把這份感受安放下來、拉長時間留存、或從宏觀脈絡理解。
4. 【微｜當下停留】：允許停留在原地、收縮至此刻最小一步、或單純任由這份狀態安靜存在。
    ...
    const responseSchema = {
      ...
      properties: {
        stems: {
          type: 'ARRAY',
          items: { type: 'STRING' },
          description: '依序為近、中、遠、微 4 個視角的句子起手式（輸出 4 句），每句以「……」結尾。'
        }
      },
      required: ['stems']
    };
