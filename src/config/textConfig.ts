...
export const UI_TEXT = {
  ...
  chat: {
    ...
    userTurnLabel: '你剛才說',
    aiMirrorLabel: '此刻的拉扯',
    loadingHint: '正在從這句話裡整理客觀的拉扯…',
    errorHint: 'AI暫時無回應',
    retryBtn: '再試一次',
    continueBtn: '＋ 接著說……',
    concludeBtn: '今天先到這裡',
    exploreBtn: '換個角度',
    closeExploreBtn: '收起角度',
    ...
    exploreLoading: '正在換個角度看看這句話…',
    exploreEmpty: '這次沒有可靠的新角度；你也可以直接接著說。',
    explorePerspectivePrefix: '換個角度：',
    exploreNextBtn: '換下一個角度',
